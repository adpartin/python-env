...
wget  Miniconda3-4.7.12.1-MacOSX-x86_64.sh  https://repo.continuum.io/miniconda/Miniconda3-4.7.12.1-MacOSX-x86_64.sh 

# Make installer executable
# chmod  u+x  Miniconda3-4.7.12.1-Linux-x86_64.sh
chmod  u+x  Miniconda3-4.7.12.1-MacOSX-x86_64.sh 

# Run installer, accepting the defaults.
# bash  Miniconda3-4.7.12.1-Linux-x86_64.sh  -b -p  ~/miniconda3
bash  Miniconda3-4.7.12.1-MacOSX-x86_64.sh  -b -p  ~/miniconda3
